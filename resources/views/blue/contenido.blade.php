...
<div class="templatemo-content col-1 light-gray-bg">
    <div class="templatemo-content-container">
        <div class="templatemo-content-widget white-bg">
            ...
            {!!Form::open(['route'=>'blue.store','method'=>'POST'])!!}
            <div class="row form-group">
                ...
                <div class="col-lg-4 col-md-6 form-group">
                    ...
                    {!!Form::text('appat',null,['class'=>'form-control','placeholder'=>'Ingresa tu apellido paterno'])!!}
                </div>
                <div class="col-lg-4 col-md-6 form-group">
                    {!!Form::label('Apellido Materno:')!!}
                    {!!Form::text('amat',null,['class'=>'form-control','placeholder'=>'Ingresa tu apellido materno'])!!}
                </div>
            </div>
            <div class="row form-group">
            ...
            <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">                  
                    {!!Form::label('Password:')!!}
                    {!!Form::text('password',null,['class'=>'form-control','placeholder'=>'Ingresa tu contraseña'])!!}
                </div>
                <div class="col-lg-6 col-md-6 form-group">                  
                    {!!Form::label('Confirma Password:')!!}
                    {!!Form::text('confpassword',null,['class'=>'form-control','placeholder'=>'Vuelve a ingresar tu contraseña'])!!}
                </div> 
            </div>
            {!!Form::submit('Registrar',['class'=>'templatemo-blue-button'])!!}
            {!!Form::reset('Cancelar',['class'=>'templatemo-white-button'])!!}
            {!!Form::close()!!}
        </div>
    </div>
